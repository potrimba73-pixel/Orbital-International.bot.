...
module.exports = {
  ...
  async execute(client) {
    ...
    // Anti-spam: procura mensagem existente do bot com embed de regras
    ...
    try {
      if (existingMessage) {
        ...
        console.log('✅ Painel de regras atualizado (anti-spam ativo).');
      } else {
        await channel.send({ embeds: [embed], components: [row] });
        console.log('✅ Painel de regras enviado no canal de regras.');
      }
    } catch (err) {
      console.error('❌ Erro ao enviar/atualizar painel de regras:', err.message);
    }
  }
};
